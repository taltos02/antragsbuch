...
\hypersetup{pdfauthor = {\organ}, pdftitle = {Antragsbuch zum \lpt}} 
...
\input{src/formalien/info-akkreditierung}
\input{src/formalien/hinweisego}
\input{src/formalien/anfahrt}

% ---------- Tagesordnung und Vorläufige Antragsblöcke

\include{src/tagesordnung}
...
\include{src/wahlvorbereitung/x01}
\include{src/wahlvorbereitung/x02}
\include{src/wahlvorbereitung/x03}

\chapter{Strukturanträge}\label{Strukturantraege} % Umlaute im label Befehl gehen nicht!

\include{src/strukturantraege/s01}
\include{src/strukturantraege/s02}
\include{src/strukturantraege/s03}
\include{src/strukturantraege/x04}
\include{src/strukturantraege/x05}
\include{src/strukturantraege/x06}
